...
namespace Files.App.Data.Contracts
{
	internal sealed class ImagingService : IImageService
	{
		...
		{
			var iconData = await FileThumbnailHelper.GetIconAsync(storable.Id, Constants.ShellIconSizes.Large, storable is IFolder, IconOptions.ReturnIconOnly | IconOptions.UseCurrentScale);
			if (iconData is null)
				return null;
